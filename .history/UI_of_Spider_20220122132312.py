            ...
            if isinstance(self.chapter_links_analyze, list):
                ...
                for index_page in whole_book_page:
                    ...
                    for link in data_response.xpath(self.chapter_links_analyze)[12:]:
                        ...
                        next_page_link = link.split('.html')[0] + '_2.html'
                        print
                        chapter_links.append(next_page_link)
                        next_page_link = link.split('.html')[0] + '_3.html'
                        chapter_links.append(next_page_link)
                        next_page_link = link.split('.html')[0] + '_4.html'
                        chapter_links.append(next_page_link)
                        next_page_link = link.split('.html')[0] + '_5.html'
                        chapter_links.append(next_page_link)
                self.chapter_links = chapter_links
